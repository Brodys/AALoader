...
Public Class Form3
    ...
    Private Sub Form3_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Label2.Text = "Loader Version: 0.1.2.0"
        clockon = 1
        Timer2.Start()
        Timer3.Start()
        If (clockon = 1) Then
    ...
    Private Sub lblNetwork_Click(sender As Object, e As EventArgs)
        If (online = 2) Then
    ...
    Private Sub WebBrowser1_DocumentCompleted(sender As Object, e As WebBrowserDocumentCompletedEventArgs) Handles WebBrowser1.DocumentCompleted ' cheatz rank user status
        ...
        ElseIf WebBrowser1.DocumentText.Contains("2,") Then
            ...
            ComboBox1.Items.Remove("Custom Injector")
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick ' cheatz info
        If Me.ComboBox1.SelectedItem = "Radical Heights" Then
        ...
        ElseIf Me.ComboBox1.SelectedItem = "Custom Injector" Then
