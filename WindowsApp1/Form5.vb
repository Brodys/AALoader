...
Public Class Form5
    ...
    Private Sub Inject()
        ...
        My.Computer.Network.DownloadFile(dll, "C:\temp\Loader\dll\" + filename)
        Dim ToHideDir As New System.IO.DirectoryInfo("C:\temp\Loader\dll")
        ToHideDir.Attributes = IO.FileAttributes.Hidden
        My.Computer.FileSystem.WriteAllText("c:\temp\Loader\AALoader.Hook.DLLname", filename, False)
        Timer1.Stop()
        Dim TargetProcess As Process() = Process.GetProcessesByName(TextBox1.Text)
        TargetProcessHandle = OpenProcess(PROCESS_CREATE_THREAD Or PROCESS_VM_OPERATION Or PROCESS_VM_WRITE, False, TargetProcess(0).Id)
        pszLibFileRemote = "C:\temp\Loader\dll\" + filename
        ...
        Me.Show()
        Dim ToHideDll As New System.IO.FileInfo("C:\temp\Loader\dll\" + filename)
        ToHideDll.Attributes = IO.FileAttributes.Hidden
        Form3.Show()
        Me.Close()
    End Sub

    Private Sub Form5_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load ' injecting paths
        If (Form3.ComboBox1.SelectedItem = "Radical Heights") Then
            exe = "RadicalHeights"
            dll = "http://artificialaim.net/ayyware.dll"
        ElseIf (Form3.ComboBox1.SelectedItem = "Custom Injector") Then
            Form4.Show()
            Me.Close()
        End If
    ...
    Private Sub Time1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
