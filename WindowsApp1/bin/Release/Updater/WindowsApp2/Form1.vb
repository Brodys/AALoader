...
Public Class Form1
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        fileReader = My.Computer.FileSystem.OpenTextFileReader("C:\temp\Loader\AALoader.Hook.Path")
        ...
        If (ProgressBar1.Value = 20) Then
            ...
            My.Computer.Network.DownloadFile("http://artificialaim.net/loader/AALoader.exe", TextBox1.Text)
